...
module.exports = function (restClient) {
    ...
    module.shippingMethodsFromProduct = function (customerToken, productId, postcode) {
        if (customerToken && isNumeric(productId)) {
            return restClient.get(`/frete/cotacao?postcode=${postcode}&itemId=${productId}`, customerToken)
        } else 
        {
            return restClient.get(`/frete/cotacao?postcode=${postcode}&itemId=${productId}`)
        }
    }
